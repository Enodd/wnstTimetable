...
export const SidebarContext = createContext<SidebarProps>({ groups: [], conductors: [] });
...
export const SidebarProvider: React.FC<PropsWithChildren> = ({ children }) => {
  ...
  return <SidebarContext.Provider value={{ groups: GroupTreeData.data ?? [], conductors: ConductorData.data ?? [] }}>
    {children}
